...
public class UIRouter implements IUIRouter {
    ...
    public boolean openUri(Context context, Uri uri, Bundle bundle, Integer requestCode) {
        for (IComponentRouter temp : uiRouters) {
            try {
                //ignore params check
                com.luojilab.component.componentlib.router.ui.VerifyResult verifyResult = temp.verifyUri(uri,bundle,false);
...
//                }
    ...
    public com.luojilab.component.componentlib.router.ui.VerifyResult verifyUri(Uri uri, Bundle bundle, boolean checkParams) {
        ...
        for (IComponentRouter temp : uiRouters) {
            com.luojilab.component.componentlib.router.ui.VerifyResult result = temp.verifyUri(uri, bundle, checkParams);
//            if (result != null) {
                if (result.isSuccess())
                    return result;
...
//            }
        ...
        return new com.luojilab.component.componentlib.router.ui.VerifyResult(false, new UiRouterException(msg) {
        });
